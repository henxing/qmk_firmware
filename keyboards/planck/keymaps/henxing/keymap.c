...
[_QWERTY] = LAYOUT_planck_grid(
  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T, TG(_ADJUST), KC_NO,   KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,
  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,  TG(_LOWER), KC_NO,   KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,
  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B, TG(_QWERTY), KC_NO,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,
